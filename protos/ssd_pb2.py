...
_BIDIRECTIONALFEATUREPYRAMIDNETWORKS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=_b("fast_attention").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
  ],
...
BidirectionalFeaturePyramidNetworks = _reflection.GeneratedProtocolMessageType('BidirectionalFeaturePyramidNetworks', (_message.Message,), dict(
